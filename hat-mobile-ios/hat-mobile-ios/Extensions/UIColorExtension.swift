...
extension UIColor {
    ...
    static let teal: UIColor = UIColor(red: 33 / 255, green: 86 / 255, blue: 152 / 255, alpha: 1)
    static let tealDark: UIColor = UIColor(red: 3 / 255, green: 3 / 255, blue: 82 / 255, alpha: 1)
    static let tealLight: UIColor = UIColor(red: 40 / 255, green: 104 / 255, blue: 185 / 255, alpha: 1)
    static let appAlternative: UIColor = UIColor(red: 48 / 255, green: 126 / 255, blue: 226 / 255, alpha: 1)
    static let appAlternative2: UIColor = UIColor(red: 25 / 255, green: 63 / 255, blue: 111 / 255, alpha: 1)
